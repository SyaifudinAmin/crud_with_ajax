...
<html>
    <head>
      ...
      <link rel="stylesheet" href="assets/css/tbstyle.css">
      <script type="text/javascript" src="assets/js/item-ajx.js"></script>
      <script type="text/javascript">
        var url = "http://localhost/TUGAS/";
      </script>
    </head>
    <body>
      <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
              <b><a class="navbar-brand" href="?f=beranda">ManApps</a></b>
      ...
      <footer class="footer">
        <div class="container">
          <span class="text-muted">Copyright © 2018 Syaifudin Amin | 5150411002. All rights reserved. </span>
        </div>
      </footer>
    </body>
</html>
